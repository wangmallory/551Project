...
We apply two methods to forecast CO2 emissions. We start by using a classical linear regression model and then Bayes linear regression approach. In both cases, we use data from 1975-2013 to train the model and data from 2014-2018 to compare the results. 
