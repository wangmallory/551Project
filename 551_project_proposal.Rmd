...
The data is country reported, calibrated by United Nations, which means data could not be accurate. However, for the purposes of this assignment, we will attempt to estimate according to reported values as truths. 
